@extends('layouts.app')
@section('title', 'ModaWeb - Registro')
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="address" type="text" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ old('birthday') }}" required autocomplete="birthday" autofocus>
                        ...
                        <div class="row mb-0">
                            <button type="submit" class="btn btn-secondary btn-block text-uppercase" style="background-color: #D72E66; color:black">
                                Registrarse 
