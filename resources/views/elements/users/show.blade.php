@extends('layouts.app')
@section('title', 'modaweb - Ver Usuarios')
    ...
    <div class="col-md-10 offset-md-1">
        ...
        <form>
            ...
            <div class="mb-3">
                ...
                <div class="">
                    <input id="birthday" type="text" class="form-control @error('birthday') is-invalid @enderror" name="birthday" value="{{ $user->birthday }}" disabled autocomplete="birthday" autofocus>
                </div>
            </div>
            ...
            <div class="mb-3">
              <div class="mb-3">
                ...
                <div class="">
                    <input id="role" type="text" class="form-control @error('role') is-invalid @enderror" name="role" value="{{ $user->role->name }}" disabled autocomplete="birthday" autofocus>
                </div>
              </div>
            </div>
