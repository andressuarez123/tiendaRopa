@extends('layouts.app')
@section('title', 'modaweb - Editar Peliculas')

@section('content')
<div class="row">
    <div class="col-md-10 offset-md-1">
        <h1> <i class="fa fa-pen"></i> Editar Pelicula</h1>
        <hr>
        ...
        <form method="POST" action="{{route('products.update',$product->id)}}" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <div class="">
                    <input id="release_year" type="date" class="form-control @error('release_year') is-invalid @enderror" name="release_year" value="{{ $product->release_year }}" required autocomplete="release_year" autofocus>
            ...
            <div class="mb-3">
                ...
                <div class="">
                    <input id="language" type="text" class="form-control @error('language') is-invalid @enderror" name="language" value="{{ $product->language }}" required>
            ...
            <div class="form-group mb-3">
                <div class="text-center my-3">
                    <img src="{{ asset($product->image) }}" class="img-thumbnail" id="preview" width="120px">
                </div>
            ...
            <div class="mb-3">
                ...
                <div class="">
                    <input id="video_link" type="text" class="form-control @error('video_link') is-invalid @enderror" name="video_link" value="{{ $product->video_link }}" required>
            ...
            <div class="mb-3">
                ...
                <div class="">
                    <input id="download_link" type="text" class="form-control @error('download_link') is-invalid @enderror" name="download_link" value="{{ $product->download_link }}" required>
